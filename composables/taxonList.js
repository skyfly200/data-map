...
export function isTaxonName(value) {
 ...
 */
export function parseTaxa(value) {
...
export function rejectedTaxa(value) {
  const parts = Array.isArray(value) ? value : String(value ?? '').split(',')
  return parts
...
export function formatTaxa(list) {
 ...
 * a line that round-trips unchanged is one nobody has to wonder about.
 */
export function asEnvLine(list) {
...
export function matchingPreset(list) {
