...
export const OPTION_DOCS = [
  ...
  },
  {
    ...
    detail: [
      ...
      'They are two controls because they are two questions. The **Basemap** button is a single choice from five, made once and rarely revisited. The **Layers** button opens a window for the overlays, which is where the list has grown — the built-in catalogue, the Earth Engine layers, and whatever assets FRMS has registered of its own. That window stays open while you work the map, because whether a layer was worth switching on is something you judge by looking at the map, not at the list.',
