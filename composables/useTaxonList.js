...
import { FRMS_GENERA, formatTaxa, parseTaxa } from './taxonList.js'
...
export function useTaxonList() {
  ...
  const taxa = useState('inat-taxa', () => [...FRMS_GENERA])
