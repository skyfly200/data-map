...
export interface MembershipProfile {
  ...
  ee_quota_monthly: number
  ee_jobs_per_day: number
  ee_max_points: number
  ee_max_concurrent: number
...
export function useMembership() {
  ...
  const tier = useState<string>('membership-tier', () => 'free')
  const profile = useState<MembershipProfile | null>('membership-profile', () => null)
   ...
   */
  async function loadProfile(): Promise<MembershipProfile | null> {
