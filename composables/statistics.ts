...
export const isPresent = (v: any): v is (string | number | boolean) => v !== null && v !== undefined && v !== ''
...
export function fieldValue(row: Record<string, any>, key: string): number | null {
  if (key === 'rain7') {
...
export function meanSd(values: (number | null)[]): MeanSdResult {
